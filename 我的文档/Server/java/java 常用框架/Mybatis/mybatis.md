...
```
- ![](https://raw.githubusercontent.com/MrSunflowers/images/main/note/images/202203172150611.png)
# 默认的类型别名
![](https://raw.githubusercontent.com/MrSunflowers/images/main/note/images/202203172150369.png)
![](https://raw.githubusercontent.com/MrSunflowers/images/main/note/images/202203172151184.png)
...
```
- 关闭延迟加载，两条SQL语句都运行了![](https://raw.githubusercontent.com/MrSunflowers/images/main/note/images/202203172151763.png)
- 开启延迟加载，只运行获取emp的SQL语句
![](https://raw.githubusercontent.com/MrSunflowers/images/main/note/images/202203172152431.png)
```java
@Test
public void getEmpAndDeptByStepOne() {
	SqlSession sqlSession = SqlSessionUtils.getSqlSession();
...
```
- 开启后，需要用到查询dept的时候才会调用相应的SQL语句![](https://raw.githubusercontent.com/MrSunflowers/images/main/note/images/202203172152090.png)
...
```
![](https://raw.githubusercontent.com/MrSunflowers/images/main/note/images/202203172152645.png)
...
```
![](https://raw.githubusercontent.com/MrSunflowers/images/main/note/images/202203172152932.png)
...
```
### 执行MBG插件的generate目标
- ![](https://raw.githubusercontent.com/MrSunflowers/images/main/note/images/202203172153042.png)
- 如果出现报错：`Exception getting JDBC Driver`，可能是pom.xml中，数据库驱动配置错误
	- dependency中的驱动![](https://raw.githubusercontent.com/MrSunflowers/images/main/note/images/202203172153892.png)
	- mybatis-generator-maven-plugin插件中的驱动![](https://raw.githubusercontent.com/MrSunflowers/images/main/note/images/202203172153441.png)
	- 两者的驱动版本应该相同
- 执行结果![](https://raw.githubusercontent.com/MrSunflowers/images/main/note/images/202203172153440.png)
## QBC
### 查询
- `selectByExample`：按条件查询，需要传入一个example对象或者null；如果传入一个null，则表示没有条件，也就是查询所有数据
- `example.createCriteria().xxx`：创建条件对象，通过andXXX方法为SQL添加查询添加，每个条件之间是and关系
- `example.or().xxx`：将之前添加的条件通过or拼接其他条件
![](https://raw.githubusercontent.com/MrSunflowers/images/main/note/images/202203172154939.png)
```java
...
```
![](https://raw.githubusercontent.com/MrSunflowers/images/main/note/images/202203172154813.png)
### 增改
- `updateByPrimaryKey`：通过主键进行数据修改，如果某一个值为null，也会将对应的字段改为null
	- `mapper.updateByPrimaryKey(new Emp(1,"admin",22,null,"456@qq.com",3));`
	- ![](https://raw.githubusercontent.com/MrSunflowers/images/main/note/images/202203172154644.png)
- `updateByPrimaryKeySelective()`：通过主键进行选择性数据修改，如果某个值为null，则不修改这个字段
	- `mapper.updateByPrimaryKeySelective(new Emp(2,"admin2",22,null,"456@qq.com",3));`
	- ![](https://raw.githubusercontent.com/MrSunflowers/images/main/note/images/202203172154577.png)
# 分页插件
## 分页插件使用步骤
### 添加依赖
```xml
...
- ![](https://raw.githubusercontent.com/MrSunflowers/images/main/note/images/202203172154352.png)
```xml
<plugins>
	<!--设置分页插件-->
...
![](https://raw.githubusercontent.com/MrSunflowers/images/main/note/images/202203172155742.png)
### 分页相关数据
#### 方法一：直接输出
```java
@Test
