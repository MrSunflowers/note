...
11. 安装成功后，继续运行数据库的初始化命令，成功后得到临时密码
```shell
2022-03-04T14:00:36.493432Z 0 [Warning] [MY-010918] [Server] 'default_authentication_plugin' is deprecated and will be removed in a future release. Please use authentication_policy instead.
2022-03-04T14:00:36.493445Z 0 [System] [MY-013169] [Server] /opt/mysql_8.0.28/bin/mysqld (mysqld 8.0.28) initializing of server in progress as process 46880
2022-03-04T14:00:36.500883Z 1 [System] [MY-013576] [InnoDB] InnoDB initialization has started.
2022-03-04T14:00:37.794303Z 1 [System] [MY-013577] [InnoDB] InnoDB initialization has ended.
2022-03-04T14:00:40.601373Z 6 [Note] [MY-010454] [Server] A temporary password is generated for root@localhost: kHx36roL_Oza
```

12. 运行脚本
```shell
/opt/mysql_8.0.28/support-files/mysql.server start
```

13. 添加mysqld服务到系统(这里要切换到安装目录下执行) 
...
23. idea 连接数据库并创建 mydb
```sql
-- jdbc:mysql://101.43.208.215:3306/mysql
